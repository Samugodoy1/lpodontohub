      ...
      <div className="max-w-4xl mx-auto" id="sistemas-para-dentista-seo-layout">
        ...
        <div className="apple-prose max-w-none space-y-6">
          ...
          <div className="space-y-4 my-6">
            <div className="flex gap-4 items-start bg-slate-50 border border-brand-border p-4 rounded-xl">
              <div className="w-8 h-8 rounded-full bg-brand-green-soft text-brand-green flex items-center justify-center font-semibold text-xs shrink-0">1</div>
              <div>
                <h4 className="font-semibold text-apple-ink text-[17px]">Tempo de cadastro da primeira agenda do dia</h4>
            ...
            <div className="flex gap-4 items-start bg-slate-50 border border-brand-border p-4 rounded-xl">
              <div className="w-8 h-8 rounded-full bg-indigo-50 text-indigo-700 flex items-center justify-center font-semibold text-xs shrink-0">2</div>
              <div>
                <h4 className="font-semibold text-apple-ink text-[17px]">Facilidade do Envio de Mensagens de Confirmação</h4>
            ...
            <div className="flex gap-4 items-start bg-slate-50 border border-brand-border p-4 rounded-xl">
              <div className="w-8 h-8 rounded-full bg-amber-50 text-amber-800 flex items-center justify-center font-semibold text-xs shrink-0">3</div>
              <div>
                <h4 className="font-semibold text-apple-ink text-[17px]">Controle de Faturamento Prático</h4>
        ...
        <div className="mt-12 p-8 md:p-10 rounded-[28px] bg-black text-white flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="space-y-3 max-w-xl text-center md:text-left">
            ...
            <h3 className="text-[24px] font-semibold tracking-tight text-white">Escolha o seu plano de voada clínica sem dores</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto shrink-0">
            <Link to="/" className="w-full sm:w-auto">
              <Button variant="primary" className="w-full py-4 px-8  ">
                Começar Gratuitamente
              </Button>
            </Link>
            <Link to="/academy" className="w-full sm:w-auto">
              <Button variant="outline" className="w-full py-4 px-8  bg-white text-brand-text border-slate-200">
                Plano Academy
              </Button>
            </Link>
          </div>
